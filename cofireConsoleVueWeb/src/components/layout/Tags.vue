    ...
    <div class="tags-close-box">
      <el-dropdown @command="handleTags">
        <el-button size="mini" type="primary">
          {{this.$t("common.label.tags")}}
          <i class="el-icon-arrow-down el-icon--right"></i>
        </el-button>
        <el-dropdown-menu size="small" slot="dropdown">
          <el-dropdown-item command="other">{{this.$t("common.label.closeOther")}}</el-dropdown-item>
          <el-dropdown-item command="all">{{this.$t("common.label.closeAll")}}</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    setTags(route) {
      ...
      if (!isExist && route.path != this.homeItem.path) {
