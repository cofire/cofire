...
public class ZipUtils {
    ...
    /**
     * 函数名称 initOutStream 功能 初始化out对象 输入 outputFileName-输出的zip文件名（带路径） 输出 true-success false-fail author chl_seu 创建日期
     * 08.10.27
     */
    ...
    /**
     * 函数名称 closeOutStream 功能 关闭out对象 输入 输出 true-success false-fail author chl_seu 创建日期 08.10.27
     */
    ...
    /**
     * 函数名称 zipPath 功能 压缩文件夹 输入 inputFileName-要压缩的文件夹 outputFileName-输出的zip文件名（带路径） 输出 true-success false-fail author
     * chl_seu 创建日期 08.10.27
     */
    ...
    /**
     * 函数名称 zipAddFile 功能 压缩文件夹 输入 inputFileName-要压缩的文件夹 outputFileName-输出的zip文件名（带路径） 输出 true-success false-fail author
     * chl_seu 创建日期 08.10.27
     */
