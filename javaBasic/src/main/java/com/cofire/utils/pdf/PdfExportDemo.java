...
public class PdfExportDemo {
    ...
    public PdfExportDemo(File file) {
    ...
    public PdfExportDemo(String fileName) throws IOException {

        File file = new File("src\\source\\" + fileName + ".pdf");
        file.createNewFile();
        document.setPageSize(PageSize.A4);// 设置页面大小
        try {
            PdfWriter.getInstance(document, new FileOutputStream(file));
    ...
    public static void main(String[] args) throws Exception {
        ...
        new PdfExportDemo(fileName).generatePDF();
    }
