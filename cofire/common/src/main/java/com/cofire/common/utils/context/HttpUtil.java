...
public class HttpUtil {
    ...
    public static void main(String[] args) {
        // String url = "http://127.0.0.1:1245/delInnerVehicle";
        String param = "{\"pageNo\":1,\"pageSize\":50}";
        // sendPostByJson(url, param);

        String url = "http://192.168.100.115:8088/proxy/pms/getVehicleInOutRecordPage";
        String param1 = "url=http://127.0.0.1:1245/getVehicleInOutRecordPage&param=" + param;
