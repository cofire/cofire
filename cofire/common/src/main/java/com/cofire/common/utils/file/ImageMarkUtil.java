...
public class ImageMarkUtil {
    ...
    public static void ImageByText(String logoText, String srcImgPath, String targerPath) {
        ImageByText(logoText, srcImgPath, targerPath, null, null);
    }
     ...
     * @param degree
     */
    public static void ImageByText(String logoText, String srcImgPath, String targerPath, Integer degree, String suffix) {
        if (null == degree) {
            degree = 45;
        }
        if (null == suffix) {
    ...
    public static void main(String[] args) {
        ImageByText("hello world", "D:/data/upload/2019/5/24/5f8c7807ea2b43abb0eabc19dee48a20.png", "D:/data/upload/2019/5/24/3.png", 45, "jpg");
    }
